...
int main()
{
	...
	cout << "How many registered voters were surveyed? " //compile error: removed semicolon
	cin >> numberSurveyed;
	...
	cout >> pctCox << "% say they will vote for Cox." << endl; //compile error: wrong direction of cout arrows
